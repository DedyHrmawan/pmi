											...
											<tbody>
												<tr>
													...
													<td class="text-end">
														...
														<a href="" title="Edit Profil" data-bs-toggle="modal" data-bs-target="#mdl_editprofil" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
														...
														<a href="#" title="Hapus Profil" data-bs-toggle="modal" data-bs-target="#mdl_delprofil" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
												...
												<tr>
													...
													<td class="text-dark fw-bolder text-hover-primary fs-6">
														Siap dengan darah yang aman, cukup dan setiap saat dengan Pelayanan Prima mengikuti Perkembangan Teknologi Mutakhir mengacu Managemen Mutu
													</td>
													<td class="text-end">
														<a href="" title="Detail Profil" data-bs-toggle="modal" data-bs-target="#mdl_detailinfo" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
															<!--begin::Svg Icon | path: assets/media/icons/duotune/general/gen045.svg-->
