                            ...
                            <div class="card mb-5 mb-xl-8">
                                ...
                                <div class="card-body py-3">
                                    ...
                                    <div class="table-responsive">
                                        <!--begin::Table-->
                                        <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="BeritaTable">
                                            <!--begin::Table head-->
                                            <thead>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        ...
                                                        <a href="" title="Edit Berita" data-bs-toggle="modal" data-bs-target="#editBerita" data-id="'.$item->id_informasi.'" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm editInfo me-1">
                                                        ...
                                                        <a href="#" title="Hapus Berita" data-bs-toggle="modal" data-bs-target="#hapusBerita" data-id="'.$item->id_informasi.'" class="btn btn-icon btn-bg-light btn-active-color-primary hapusInfo btn-sm">
