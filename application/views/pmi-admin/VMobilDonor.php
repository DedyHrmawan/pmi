                    ...
                    <form id="" class="form" action="#">
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <div class="position-relative d-flex align-items-center">
                                <!--begin::Datepicker-->
                                <input class="form-control form-control-solid jadwal" placeholder="Pilih Jadwal" name="" id="jadwal" />
                                <!--end::Datepicker-->
                            </div>
                        </div>
                         <!--begin::Input group-->
                         <div class="row g-9 mb-8">
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="Masukan Jam Buka" name="" id=""/>
                            </div>
                            <!--end::Col-->
                            <!--begin::Col-->
                            <div class="col-md-6 fv-row">
                                ...
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-solid" placeholder="Masukan Jam Tutup"  id=""/>
                                <!--end::Input-->
                            </div>
                            <!--end::Col-->
                        </div>
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Pilih Status" name="target_assign">
