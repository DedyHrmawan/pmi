                                        ...
                                        <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <a href="" title="Detail Informasi" data-bs-toggle="modal" data-bs-target="#mdl_detailinfo" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                        ...
                                                        <a href="" title="Edit Informasi" data-bs-toggle="modal" data-bs-target="#mdl_editinfo" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                        ...
                                                        <a href="#" title="Hapus Informasi" data-bs-toggle="modal" data-bs-target="#mdl_delinfo" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
