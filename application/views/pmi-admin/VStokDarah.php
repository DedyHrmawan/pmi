<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-enabled aside-fixed">
                                                ...
                                                <?php
                                                    ...
                                                    foreach($darah as $item){
                                                        ...
                                                        echo '
                                                            ...
                                                            <td class="text-end">
                                                                <a href="" title="Edit Stok Darah" data-bs-toggle="modal" data-id="'.$item->id_darah.'" data-bs-target="#editStok" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm editStok me-1">
                                                                ...
                                                                <a href="#" title="Hapus Stok Darah" data-bs-toggle="modal" data-id="'.$item->id_darah.'" data-bs-target="#hapusStok"  class="btn btn-icon btn-bg-light btn-active-color-primary hapusStok btn-sm">
        ...
        <div class="modal fade" tabindex="-1" id="tambahDarah">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="number" class="form-control form-control-solid" placeholder="Masukan Jumlah Stok Darah" name="stok" />
                        </div>
                    </div>
        ...
        <div class="modal fade" tabindex="-1" id="editStok">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="number" id="stok_edit" class="form-control form-control-solid" name="stok" />
                        </div>
                    </div>
