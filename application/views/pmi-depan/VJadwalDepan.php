...
<div class="pb-15 pt-18 landing-red-bg">
	...
	<div class="container">
		...
		<div class="text-center mt-8 mb-8" id="" data-kt-scroll-offset="{default: 100, lg: 150}">
			<!--begin::Title-->
			<h3 class="fs-2hx text-white fw-bolder mb-5">Jadwal Donor Darah UDD PMI Kota Malang</h3>
			<!--end::Title-->
			<br>
			<br>
			<!--begin::Statistics-->
							...
							foreach ($jadwal_mobil as $item) {
								...
								echo '
										<tr>
											...
											<td> <a href="' .  base_url("booking") . '" class="btn btn-white btn-color-danger text-danger fs-6">
	...
	<div class="container">
		...
		<div class="text-center mt-8 mb-8" id="" data-kt-scroll-offset="{default: 100, lg: 150}">
			<!--begin::Title-->
			<h3 class="fs-2hx text-white fw-bolder mb-5">Jadwal Mobil Keliling Donor Darah UDD PMI Kota Malang</h3>
			<!--end::Title-->
			<br>
			<br>
			<!--begin::Statistics-->
