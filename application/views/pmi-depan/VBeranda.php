				...
				<div class="tns tns-default landing-red-bg">
					...
					<div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000" data-tns-autoplay="true" data-tns-autoplay-timeout="18000" data-tns-controls="true" data-tns-nav="false" data-tns-items="1" data-tns-center="false" data-tns-dots="false" data-tns-prev-button="#kt_team_slider_prev1" data-tns-next-button="#kt_team_slider_next1">
						...
						<div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
							<img src="<?= base_url(); ?>assets/admin/media/product-demos/demo1.png" class="card-rounded shadow mw-100" alt="" />
						</div>
						<!--end::Item-->
						<!--begin::Item-->
						<div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
							<img src="<?= base_url(); ?>assets/admin/media/product-demos/demo2.png" class="card-rounded shadow mw-100" alt="" />
						</div>
						<!--end::Item-->
						<!--begin::Item-->
						<div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
							<img src="<?= base_url(); ?>assets/admin/media/product-demos/demo4.png" class="card-rounded shadow mw-100" alt="" />
						</div>
						<!--end::Item-->
						<!--begin::Item-->
						<div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
							<img src="<?= base_url(); ?>assets/admin/media/product-demos/demo5.png" class="card-rounded shadow mw-100" alt="" />
						</div>
						<!--end::Item-->
					</div>
					<!--end::Slider-->
		...
		<div class="mb-n10 mb-lg-20 z-index-2">
			...
			<div class="container">
				...
				<div class="text-center mb-17">
					<!--begin::Title-->
					<h3 class="fs-2hx text-dark mb-5" id="profil" data-kt-scroll-offset="{default: 100, lg: 150}">Layanan PMI Untuk Kalian</h3>
					<!--end::Title-->
				</div>
				<!--end::Heading-->
				<!--begin::Row-->
		...
		<div class="mt-sm-n10">
			...
			<div class="pb-15 pt-18 landing-red-bg">
				...
				<div class="container">
					<!--begin::Heading-->
					<div class="text-center mt-8 mb-8" id="informasi" data-kt-scroll-offset="{default: 100, lg: 150}">
						<!--begin::Title-->
		...
		<div class="py-10 py-lg-20">
			...
			<div class="container">
				...
				<div class="text-center mb-12">
					<!--begin::Title-->
					<h3 class="fs-2hx text-dark mb-5" id="stok" data-kt-scroll-offset="{default: 100, lg: 150}">Agenda</h3>
					<!--end::Title-->
				...
				<div class="card" style="filter: drop-shadow(0px 0px 40px rgba(68, 81, 96, 0.08))">
					...
					<div class="card-body p-lg-20">
						...
						<div class="text-left mb-5 mb-lg-10">
							...
							<h3 class="fs-2hx text-dark mt-10 mb-20" id="agenda" data-kt-scroll-offset="{default: 100, lg: 150}">Terima kasih atas dukunganmu!</h3>
							<!--end::Title-->
							<!--begin::Description-->
				...
				<div class="container">
					...
					<div class="d-flex flex-column container pt-lg-10">
						...
						<div class="mb-13 text-center">
							<h1 class="fs-2hx fw-bolder text-white mb-5" id="berita" data-kt-scroll-offset="{default: 100, lg: 150}">Kondisi Darurat? <br /> Telepon Ambulans</h1>
		...
		<div class="mb-0">
			...
			<div class="landing-red-bg pt-10">
				...
				<div class="container">
					<div class="pt-5">
						<img alt="Logo" src="<?= base_url(); ?>assets/admin/media/logo-pmi-white.svg" class="logo-default h-50px h-lg-60px" />
					</div>
					<!--begin::Row-->
						...
						<div class="col-lg-6 pe-lg-16 mb-10 mb-lg-0">
							...
							<div class="rounded landing-dark-border p-9">
								<div class="text-center">
									<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3951.257343140767!2d112.62552631415649!3d-7.972334081678316!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd628258ae8fbbb%3A0xf0959f7510ae8b17!2sPMI%20Kota%20Malang!5e0!3m2!1sid!2sid!4v1656487481206!5m2!1sid!2sid" width="400" height="250" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
								</div>
							</div>
							<!--end::Block-->
						</div>
							...
							<div class="d-flex justify-content-center">
								...
								<div class="d-flex fw-bold flex-column ms-lg-20">
									...
									<a href="https://github.com/KeenthemesHub" class="mb-6">
										<img src="<?= base_url(); ?>assets/admin/media/svg/brand-logos/github.svg" class="h-20px me-2" alt="" />
