				...
				<div class="col-lg-6 pe-lg-16 mb-10 mb-lg-10">
					...
					<div class="rounded landing-dark-border p-9">
						<div class="text-center">
							...
							<!--end::Subtitle-->
							<!--begin::Link-->
							<a href="https://www.facebook.com/UDD-PMI-KOTA-Malang-203825446408355/" class="mb-6">
							...
							<!--end::Link-->
							<!--begin::Link-->
							<a href="https://twitter.com/pmimalangkota" class="mb-6">
							...
							<!--end::Link-->
							<!--begin::Link-->
							<a href="https://www.instagram.com/pmimalangkota" class="mb-6">
