	                            ...
	                            <div class="mb-8">
	                                ...
	                                <div class="d-flex flex-wrap mb-6">
	                                    ...
	                                    <div class="my-1">
	                                        ...
	                                        <!--end::Svg Icon-->
	                                        <!--begin::Label-->
	                                        <span class="fw-bolder text-gray-400">Vincentius Leonardo Chandra</span>
	                                        <!--end::Label-->
	                                    </div>
	                                    <!--end::Item-->
	                                </div>
	                                <!--end::Info-->
	                                <!--begin::Title-->
	                                <h2 href="#" class="text-dark fs-2 fw-bolder">Admin Panel - How To Get Started Tutorial. Create a customizable SaaS Based applications and solutions
	                                    <!--end::Title-->
	                                    <!--begin::Container-->
